    ...
    <div className={`min-h-screen ${preferences.darkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-sage-25 via-white to-sage-50'}`}>
      ...
      <header className="relative overflow-hidden h-40">
        ...
        <div className="absolute inset-0">
          ...
          >
            <path 
              d="M0,160 C240,100 480,220 720,180 C960,140 1200,240 1440,200 L1440,320 L0,320 Z" 
          ...
          >
            <path 
              d="M0,240 C360,160 600,280 840,220 C1080,160 1320,260 1440,210 L1440,320 L0,320 Z" 
          ...
          >
            <path 
              d="M0,280 C180,240 420,300 660,260 C900,220 1260,300 1440,280 L1440,320 L0,320 Z" 
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="relative overflow-hidden">
          ...
          >
            <path 
              d="M0,60 C360,20 600,50 840,30 C1080,10 1320,40 1440,25 L1440,0 L0,0 Z" 
              fill="rgba(255,255,255,0.1)"
            />
          </svg>
          ...
          <div className="relative flex items-center justify-around px-6 py-4 max-w-lg mx-auto">
            ...
            <Button
              onClick={() => navigate('/')}
              variant="ghost"
              className="flex flex-col items-center text-white hover:text-sage-200 hover:bg-white/20 rounded-2xl transition-all duration-300 transform hover:scale-110"
            >
            ...
            <Button
              ...
              className="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110 hover:rotate-12"
            >
