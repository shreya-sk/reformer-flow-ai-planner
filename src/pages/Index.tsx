...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen ${preferences.darkMode ? 'dark bg-gray-900' : 'bg-gradient-to-br from-sage-25 via-white to-sage-50'} pb-20`}>
      ...
      <div className="bg-white/90 backdrop-blur-sm border-b border-sage-200 px-4 py-3">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-lg font-bold text-sage-800">Reformerly</h1>
            <p className="text-xs text-sage-600">Plan & Teach Classes</p>
          </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <Button
          ...
          className="w-full bg-gradient-to-r from-sage-500 via-sage-600 to-sage-700 hover:from-sage-500 to-sage-700 text-white py-4 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300"
          size="lg"
        >
        ...
        <div className="grid grid-cols-3 gap-3">
          <Card className="bg-white shadow-sm">
            <CardContent className="p-3 text-center">
              <div className="text-xl font-bold text-sage-700 mb-1">{classPlans.length}</div>
              <div className="text-xs text-sage-600">Classes</div>
            </CardContent>
          </Card>
          <Card className="bg-white shadow-sm">
            <CardContent className="p-3 text-center">
              <div className="text-xl font-bold text-sage-700 mb-1">{totalExercises}</div>
              <div className="text-xs text-sage-600">Exercises</div>
            </CardContent>
          </Card>
          <Card className="bg-white shadow-sm">
            <CardContent className="p-3 text-center">
              <div className="text-xl font-bold text-sage-700 mb-1">{Math.round(totalDuration / 60)}h</div>
